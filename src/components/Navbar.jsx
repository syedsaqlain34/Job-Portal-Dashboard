...
const Navbar = () => {
  ...
  return (
    <header className="flex items-center justify-between bg-primary text-accent px-4 sm:px-6 py-3">
      ...
      {open && (
        <div className="md:hidden absolute left-4 right-4 top-16 bg-accent border rounded-lg p-4 shadow-lg z-40">
